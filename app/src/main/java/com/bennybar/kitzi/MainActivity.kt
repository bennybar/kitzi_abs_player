...
/**
 * The bottom navigation bar, styled like the Flutter one: a surfaceContainerHigh
 * surface with 28dp rounded top corners, a hairline top border, always-shown
 * labels, and a stadium-shaped selection indicator.
 */
@Composable
